 ...
 * 
 * Este programa llee el sensor ultrasonico con la biblioteca Ultrasonic de Erick Simoes 
 * en su version 3.0.0 SE mezcla con el progrma ESP32CAM-MQTT-basic del repositorio del codigo iot
 * 
...
#include <Ultrasonic.h>  // Biblioteca para conectarte al sensor

//Datos de WiFi
const char* ssid = "Totalplay-93A2";  // Aquí debes poner el nombre de tu red
const char* password = "93A2923929wxTMek";  // Aquí debes poner la contraseña de tu red
